...
//    }
    ...
    public ResponseEntity<UsageLogSummaryDto> getEnergyCostUsageLog(@PathVariable Long id,
                                                                    @RequestParam() LocalDateTime start, @RequestParam() LocalDateTime end )
    {
        // start = 2026-02-22T00:00:00   means 0 time at 2026/2/22
        //  end   = 2026-02-22T15:30:00  means 2:30 time today

        return ResponseEntity.status(HttpStatus.OK).body(usageLogService.getEnergyCostUsageLog(id,start,end));
    }
}
